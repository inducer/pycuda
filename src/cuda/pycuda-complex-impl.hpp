...
// Division
template <class _Tp>
static void __device__ _divT(const _Tp& __z1_r, const _Tp& __z1_i,
...
template <class _Tp>
static void __device__ _divT(const _Tp& __z1_r,
                  const _Tp& __z2_r, const _Tp& __z2_i,
                  _Tp& __res_r, _Tp& __res_i) {
  _Tp __ar = __z2_r >= 0 ? __z2_r : -__z2_r;
  _Tp __ai = __z2_i >= 0 ? __z2_i : -__z2_i;
...
// Square root
template <class _Tp>
static complex<_Tp> __device__ sqrtT(const complex<_Tp>& z) {
  _Tp re = z._M_re;
  _Tp im = z._M_im;
  _Tp mag = ::hypot(re, im);
  complex<_Tp> result;
...
// exp
template <class _Tp>
static complex<_Tp> __device__ expT(const complex<_Tp>& z) {
...
// log10
template <class _Tp>
static complex<_Tp> __device__ log10T(const complex<_Tp>& z, const _Tp& ln10_inv) {
  complex<_Tp> r;
